...
class Users(db.Model):
    ...
    connected_items_owner = db.relationship('Connected_Items', foreign_keys='Connected_Items.owner_id', backref='owner')
    connected_items_reporter = db.relationship('Connected_Items', foreign_keys='Connected_Items.reporter_id', backref='reporter')
